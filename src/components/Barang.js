...
const Barang = () => {
    ...
    return (
        <div className="container mt-5">
            ...
            <Button variant="success" className="mt-3" onClick={handleTambah}>
                Tambah Data
            </Button>

            {/* Pop-up form untuk menambahkan atau mengedit data barang */}
            <Modal show={showTambahModal || showEditModal} onHide={() => {
                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        <Form.Group>
                            <Form.Label>Foto Barang (Format JPG atau PNG, maksimum 100KB)</Form.Label>
                            <Form.Control
                                type="file"
                                name="foto"
